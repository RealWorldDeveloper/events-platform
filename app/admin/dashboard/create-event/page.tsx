                                  ...
                                  <div className="flex items-center justify-between">
                                    <div>
                                      ...
                                      <p className="text-sm text-gray-400">
                                        By default, registration closes when the
                                        event starts
                                      </p>
                                    </div>
                                    <Button
                        ...
                        <Card className="bg-gray-900 border-gray-800">
                          ...
                          <CardContent className="space-y-4">
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-gray-400">
                                Use a descriptive title that clearly
                                communicates what your event is about.
                              </p>
                            </div>
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-gray-400">
                                Provide all the information attendees need to
                                know, including what to expect and what to
                                bring.
                              </p>
                            </div>
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-gray-400">
                                ...
                                event and attracts attention.
                              </p>
                            </div>
                            <div className="space-y-2">
                              <h4 className="font-medium">Complete Agenda</h4>
                              <p className="text-sm text-gray-400">
                                Break down your event schedule so attendees know
